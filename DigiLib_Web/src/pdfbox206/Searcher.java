...
public class Searcher {
	 ...
	 */
	// public List<IndexItem> findByTitle(String queryString, int numOfResults)
	 ...
	 *            - the query string to search for
	 */
	public List<Result> findByContent(String queryString, int numOfResults) throws ParseException, IOException {
		...
		/**
		 * Old Logic to return int [Now Obsolete]
		 * if(queryResults.length>0){ return 1; } else return 0
		 */
